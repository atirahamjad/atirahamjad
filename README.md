...
![Profile Views](https://komarev.com/ghpvc/?username=atirahamjad&color=7c9ef8&style=flat-square)
...
> I build ML pipelines that replace hours of manual work with minutes of automated precision.

### Citation Quality Assessment Pipeline
ML pipeline automating academic citation quality assessment — built during a Research Assistantship at Sunway Business School.

![Precision](https://img.shields.io/badge/Precision-95%25-brightgreen) ![Time Saved](https://img.shields.io/badge/Time%20Saved-98%25-brightgreen) ![Lines](https://img.shields.io/badge/Lines%20of%20Code-12%2C500%2B-blue) ![Status](https://img.shields.io/badge/Status-Pending%20Publication-orange)

- Journal quality scoring against JCR, ABDC, and AJG-ABS databases
- Supports APA, IEEE, Chicago, Harvard, MLA
- Under consideration for university-wide adoption

[GitHub](https://github.com/atirahamjad/citation-quality-pipeline) · [Live Demo](https://citation-quality-pipeline.streamlit.app)

---

### ENVO — AI-Powered Career Guidance & University Prediction Platform
Unified AI platform combining career forecasting, institutional prediction, and NLP. Capstone project, graded A+.

![Accuracy](https://img.shields.io/badge/Forecast%20Accuracy-97%25%2B-brightgreen) ![Profiles](https://img.shields.io/badge/Career%20Profiles-1%2C395-blue) ![Grade](https://img.shields.io/badge/Capstone-A%2B-brightgreen) ![Competition](https://img.shields.io/badge/XJTLU-Semi--Finalist-orange)

- SVM classifier at 84.6% accuracy for institutional prediction
- K-Means clustering across 30,000+ US College Scorecard institutions
- Represented Sunway Business School at XJTLU Global Competition

[Demo Video](https://youtu.be/0CbLyjAeNvA) · [GitHub](https://github.com/atirahamjad/envo-ai-platform)
...
*Currently open to data science, AI/ML, and analytics roles in Malaysia*
